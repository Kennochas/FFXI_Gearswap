...
--- Hybrid Sets---
sets.TP.Ragnarok.Hybrid = {
    main="Ragnarok", 
    ammo="Seething Bomblet +1",
}
sets.TP.Ragnarok.Hybrid.MidACC = set_combine(
    sets.TP.Ragnarok.Hybrid,{
        -- Stuff goes here --
    }
)
sets.TP.Ragnarok.Hybrid.HighACC = set_combine(
    sets.TP.Ragnarok.Hybrid.MidACC,{
        -- Stuff goes here --
    }
)

-- Hybrid /SAM Hybrid Sets
sets.TP.Ragnarok.Hybrid.SAM = {
    main="Ragnarok", 
    ammo="Seething Bomblet +1",
}
sets.TP.Ragnarok.Hybrid.SAM.MidACC = set_combine(
    sets.TP.Ragnarok.Hybrid.SAM,{
        -- Stuff goes here --
    }
)
sets.TP.Ragnarok.Hybrid.SAM.HighACC = set_combine(
    sets.TP.Ragnarok.Hybrid.SAM.MidACC,{
        -- Stuff goes here --
    }
)