...
--- Hybrid Sets---
sets.TP.Liberator.Hybrid = {
    main="Liberator",
    ammo="Seething Bomblet +1",
}
sets.TP.Liberator.Hybrid.MidACC = set_combine(
    sets.TP.Liberator.Hybrid,{
        -- Stuff goes here --
    }
)
sets.TP.Liberator.Hybrid.HighACC = set_combine(
    sets.TP.Liberator.Hybrid.MidACC,{
        -- Stuff goes here --
    }
)

-- Hybrid /SAM Hybrid Sets
sets.TP.Liberator.Hybrid.SAM = {
    main="Liberator", 
    ammo="Seething Bomblet +1",
}
sets.TP.Liberator.Hybrid.SAM.MidACC = set_combine(
    sets.TP.Liberator.Hybrid.SAM,{
        -- Stuff goes here --
    }
)
sets.TP.Liberator.Hybrid.SAM.HighACC = set_combine(
    sets.TP.Liberator.Hybrid.SAM.MidACC,{
        -- Stuff goes here --
    }
)